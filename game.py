...
pygame.display.set_caption('Крестики-Yолики by LEV1N')
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if game.board[clicked_row][clicked_col] == ' ':
                    ...
                    if game.check_win(current_player):
                        conntent_wwiner = f'Победили {current_player}.'
                        print(conntent_wwiner)
                        save_result(conntent_wwiner)
                        running = False
                    elif game.is_board_full():
                        conntent_not_winner = f'Ничья.'
                        print(conntent_not_winner)
                        save_result(conntent_not_winner)
                        running = False
